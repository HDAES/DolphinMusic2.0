class RecSongListModel {
  bool hasTaste;
  int code;
  int category;
  List<SongList> result;

  RecSongListModel({this.hasTaste, this.code, this.category, this.result});

  RecSongListModel.fromJson(Map<String, dynamic> json) {
    hasTaste = json['hasTaste'];
    code = json['code'];
    category = json['category'];
    if (json['result'] != null) {
      result = new List<SongList>();
      json['result'].forEach((v) {
        result.add(new SongList.fromJson(v));
      });
    }
  }
